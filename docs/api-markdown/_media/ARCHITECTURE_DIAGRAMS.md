...
graph TB
    ...
    subgraph "MCP Server [Node.js 25.x]"
        ...
        subgraph "Business Logic"
            TOOLS[Tool Registry<br/><i>61 MCP Tools</i>]
...
2. **Tool Registry**: 61 registered MCP tools for parliamentary data access (36 EP API data tools + 3 advanced analysis + 15 OSINT intelligence + 13 feed endpoints)
