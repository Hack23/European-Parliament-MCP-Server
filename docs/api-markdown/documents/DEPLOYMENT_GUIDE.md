...
[European Parliament MCP Server API](../modules.md) / DEPLOYMENT\_GUIDE
...
4. Claude should list the 61 MCP tools
...
- [Architecture Diagrams](../_media/ARCHITECTURE_DIAGRAMS.md)
