...
| 🧪 **E2E Test Plan** | End-to-end test strategy and coverage matrix | [E2ETestPlan.md](../_media/E2ETestPlan.md) |
| 🧪 **Unit Test Plan** | Unit test plan and coverage targets | [docs/UnitTestPlan.md](../_media/UnitTestPlan.md) |
...
- **🧪 End-to-End Testing** - Full server binary over stdio transport
  - Policy: [Secure Development Policy](https://github.com/Hack23/ISMS-PUBLIC/blob/main/Secure_Development_Policy.md)
  - Coverage: 71 E2E test cases across 4 test files; see [E2ETestPlan.md](../_media/E2ETestPlan.md)
