...
Defined in: [tools/getCurrentMEPs.ts:26](https://github.com/Hack23/European-Parliament-MCP-Server/blob/67dbd67a8f5629591a17b9785bfa0977f7023afb/src/tools/getCurrentMEPs.ts#L26)
...
MCP tool result with current MEP data
