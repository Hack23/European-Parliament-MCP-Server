...
Defined in: [tools/analyzeCoalitionDynamics.ts:485](https://github.com/Hack23/European-Parliament-MCP-Server/blob/main/src/tools/analyzeCoalitionDynamics.ts#L485)
