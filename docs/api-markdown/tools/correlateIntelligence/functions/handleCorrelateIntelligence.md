...
Defined in: [tools/correlateIntelligence.ts:610](https://github.com/Hack23/European-Parliament-MCP-Server/blob/main/src/tools/correlateIntelligence.ts#L610)
