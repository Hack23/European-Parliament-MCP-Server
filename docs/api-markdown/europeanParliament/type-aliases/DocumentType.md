...
[European Parliament MCP Server API](../../modules.md) / [europeanParliament](../README.md) / DocumentType

# Type Alias: DocumentType

> **DocumentType** = `"REPORT"` \| `"RESOLUTION"` \| `"DECISION"` \| `"DIRECTIVE"` \| `"REGULATION"` \| `"OPINION"` \| `"AMENDMENT"`

Defined in: [types/europeanParliament.ts:1450](https://github.com/Hack23/European-Parliament-MCP-Server/blob/b9df29e7535477dcc3eb0083d22c22c499f6176d/src/types/europeanParliament.ts#L1450)
