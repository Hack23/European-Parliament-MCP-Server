**European Parliament MCP Server API v1.2.17**
...
| Tool | Description | Key Parameters | EP API Endpoint |
|------|-------------|----------------|-----------------|
| [`get_plenary_sessions`](documents/API_USAGE_GUIDE.md) | List plenary sessions/meetings, or single by eventId | dateFrom, dateTo, eventId, year, location | `GET /meetings`, `GET /meetings/{id}` |
...
| [`get_speeches`](documents/API_USAGE_GUIDE.md) | Plenary speeches and debate contributions | speechId, year, dateFrom, dateTo, limit | `GET /speeches`, `GET /speeches/{id}` |
| [`get_events`](documents/API_USAGE_GUIDE.md) | EP events (hearings, conferences, seminars) | eventId, year, dateFrom, dateTo, limit | `GET /events`, `GET /events/{id}` |
...
Real-time change feeds for monitoring recently updated data across all EP API categories. Per the [EP OpenAPI spec](_media/ep-openapi-spec.json), feeds fall into two groups:
...
| Tool | Description | Key Parameters | EP API Endpoint |
|------|-------------|----------------|-----------------|
| [`get_documents_feed`](documents/API_USAGE_GUIDE.md) | Recently updated documents | _(none)_ | `GET /documents/feed` |
| [`get_plenary_documents_feed`](documents/API_USAGE_GUIDE.md) | Recently updated plenary documents | _(none)_ | `GET /plenary-documents/feed` |
| [`get_committee_documents_feed`](documents/API_USAGE_GUIDE.md) | Recently updated committee docs | _(none)_ | `GET /committee-documents/feed` |
| [`get_plenary_session_documents_feed`](documents/API_USAGE_GUIDE.md) | Recently updated plenary session docs | _(none)_ | `GET /plenary-session-documents/feed` |
| [`get_parliamentary_questions_feed`](documents/API_USAGE_GUIDE.md) | Recently updated questions | _(none)_ | `GET /parliamentary-questions/feed` |
| [`get_corporate_bodies_feed`](documents/API_USAGE_GUIDE.md) | Recently updated corporate bodies | _(none)_ | `GET /corporate-bodies/feed` |
| [`get_controlled_vocabularies_feed`](documents/API_USAGE_GUIDE.md) | Recently updated vocabularies | _(none)_ | `GET /controlled-vocabularies/feed` |
