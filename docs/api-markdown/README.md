**European Parliament MCP Server API v0.6.2**
...
| [`get_voting_records`](_media/API_USAGE_GUIDE.md#tool-get_voting_records) | Retrieve voting records | mepId, sessionId, topic, dateFrom | `GET /meetings/{id}/vote-results` |
