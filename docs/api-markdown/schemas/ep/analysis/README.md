...
[European Parliament MCP Server API](../../../modules.md) / schemas/ep/analysis
...
- [CorrelateIntelligenceSchema](variables/CorrelateIntelligenceSchema.md)
...
- [OsintStandardOutputSchema](variables/OsintStandardOutputSchema.md)
