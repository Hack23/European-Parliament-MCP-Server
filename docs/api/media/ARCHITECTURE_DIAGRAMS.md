...
graph TB
    ...
    subgraph "MCP Server [Node.js 24.x]"
        ...
        subgraph "Business Logic"
            TOOLS[Tool Registry<br/><i>45 MCP Tools</i>]
...
2. **Tool Registry**: 45 registered MCP tools for parliamentary data access (28 EP API data tools + 3 advanced analysis + 14 OSINT intelligence)
