...
graph TB
    ...
    subgraph "MCP Server [Node.js 24.x]"
        ...
        subgraph "Business Logic"
            TOOLS[Tool Registry<br/><i>46 MCP Tools</i>]
...
2. **Tool Registry**: 46 registered MCP tools for parliamentary data access (28 EP API data tools + 3 advanced analysis + 15 OSINT intelligence)
