...
export const hotPathDoceoVotes = [
  {
    ...
    groupBreakdown: {
      ...
      Left: { for: 1, against: 0, abstain: 0 },
      Verts: { for: 0, against: 0, abstain: 1 },
    },
  ...
  },
  {
    ...
    groupBreakdown: {
      EPP: { for: 1, against: 0, abstain: 0 },
      'S&D': { for: 0, against: 0, abstain: 1 },
      ECR: { for: 0, against: 1, abstain: 0 },
      Renew: { for: 1, against: 0, abstain: 0 },
      Left: { for: 0, against: 1, abstain: 0 },
      Verts: { for: 1, against: 0, abstain: 0 },
    },
