 ...
 */
function buildCommitteeAssignments() {
    return [
        {
            abbreviation: 'ENVI',
            role: 'LEAD',
 ...
 */
export function createMockProcedure(procedureId) {
    return {
        procedureId,
...
//# sourceMappingURL=procedureTracker.js.map