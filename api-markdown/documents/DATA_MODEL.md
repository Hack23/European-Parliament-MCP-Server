...
[European Parliament MCP Server API](../modules.md) / DATA\_MODEL
...
*See [FUTURE_DATA_MODEL.md](../_media/FUTURE_DATA_MODEL.md) for planned enhancements including graph database support and temporal data models.*
