...
[European Parliament MCP Server API](../modules.md) / CONTRIBUTING
...
See [**docs/TOOL_DEVELOPMENT.md**](../_media/TOOL_DEVELOPMENT.md) for the full step-by-step guide. Here is the quick summary:
...
- [SBOM Documentation](../_media/SBOM.md)
- [Attestations Documentation](../_media/ATTESTATIONS.md)
