...
[European Parliament MCP Server API](../../../modules.md) / [utils/committeeCache](../README.md) / listCachedCurrentCorporateBodies

# Function: listCachedCurrentCorporateBodies()
...
[`Record`](https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type)\<`string`, \{ `abbreviation`: `string`; `id`: `string`; `members`: `string`[]; `name`: `string`; `chair?`: `string`; `meetingSchedule?`: `string`[]; `memberships?`: `object`[]; `responsibilities?`: `string`[]; `viceChairs?`: `string`[]; \}\> = `...`
