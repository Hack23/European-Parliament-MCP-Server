...
Defined in: [tools/getDocumentsFeed.ts:34](https://github.com/Hack23/European-Parliament-MCP-Server/blob/main/src/tools/getDocumentsFeed.ts#L34)
...
> **description**: `string` = `'Get recently updated European Parliament documents from the feed. Returns documents published or updated during the specified timeframe. Data source: European Parliament Open Data Portal.'`
