...
Defined in: [tools/getPlenarySessionDocumentsFeed.ts:34](https://github.com/Hack23/European-Parliament-MCP-Server/blob/main/src/tools/getPlenarySessionDocumentsFeed.ts#L34)
...
> **description**: `string` = `'Get recently updated plenary session documents from the feed. Returns plenary session documents published or updated during the specified timeframe. Data source: European Parliament Open Data Portal.'`
