...
Defined in: [tools/analyzeCoalitionDynamics.ts:1019](https://github.com/Hack23/European-Parliament-MCP-Server/blob/main/src/tools/analyzeCoalitionDynamics.ts#L1019)
