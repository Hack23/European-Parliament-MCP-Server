...
Defined in: [tools/getControlledVocabulariesFeed.ts:34](https://github.com/Hack23/European-Parliament-MCP-Server/blob/main/src/tools/getControlledVocabulariesFeed.ts#L34)
...
> **description**: `string` = `'Get recently updated controlled vocabularies from the feed. Returns controlled vocabularies published or updated during the specified timeframe. Data source: European Parliament Open Data Portal.'`
