...
export const getMEPDeclarationsToolMetadata = {
  ...
  description: 'Get MEP declarations of financial interests filed under the Rules of Procedure. Filter by year. Data source: European Parliament Open Data Portal. GDPR: Access is audit-logged.',
  inputSchema: {
