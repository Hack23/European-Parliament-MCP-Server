...
const RAW_YEARLY: Omit<YearlyStats, 'monthlyActivity' | 'politicalLandscape' | 'derivedIntelligence'>[] = [
  ...
  { year: 2026, parliamentaryTerm: 'EP10 (2024-2029)', mepCount: 718, plenarySessions: 54, legislativeActsAdopted: 114, rollCallVotes: 567, committeeMeetings: 2363, parliamentaryQuestions: 6147, resolutions: 180, speeches: 5999, adoptedTexts: 233, procedures: 935, events: 2327, documents: 4265, mepTurnover: 47, declarations: 3313, commentary: 'PARTIAL YEAR — data through Q1 2026. EP10 has 720 MEPs from 27 EU countries. Plenary session count (54) reflects the full-year EP calendar; speeches (996) and adoptedTexts (104) reflect actual Q1 cumulative activity; other activity totals are projected full-year estimates based on 2021-2025 historical average with EP10 year-2 cycle adjustment. Actual Q1 activity: 10 plenary sittings completed (Jan-Feb), adopted texts and procedures accumulating. Defence spending, Clean Industrial Deal, and AI Act implementation dominating legislative agenda.' },
];
...
export const GENERATED_STATS: GeneratedStatsData = {
  generatedAt: '2026-06-29T07:50:17Z',
