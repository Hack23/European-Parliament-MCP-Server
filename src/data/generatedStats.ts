...
const RAW_YEARLY: Omit<YearlyStats, 'monthlyActivity' | 'politicalLandscape' | 'derivedIntelligence'>[] = [
  ...
  { year: 2025, parliamentaryTerm: 'EP10 (2024-2029)', mepCount: 720, plenarySessions: 53, legislativeActsAdopted: 78, rollCallVotes: 420, committeeMeetings: 1980, parliamentaryQuestions: 4946, resolutions: 135, speeches: 10000, adoptedTexts: 347, procedures: 923, events: 2664, documents: 3516, mepTurnover: 36, declarations: 3000, commentary: 'EP10 ramp-up year (720 MEPs from 27 EU countries). New committee chairs and rapporteurs established. Defence and security policy gained prominence. Strategic autonomy debates. Clean Industrial Deal proposals. Parliament adapting to new political balance with stronger ECR and right-wing presence.' },
  { year: 2026, parliamentaryTerm: 'EP10 (2024-2029)', mepCount: 718, plenarySessions: 54, legislativeActsAdopted: 114, rollCallVotes: 567, committeeMeetings: 2363, parliamentaryQuestions: 6147, resolutions: 180, speeches: 996, adoptedTexts: 104, procedures: 935, events: 2327, documents: 4265, mepTurnover: 39, declarations: 1158, commentary: 'PARTIAL YEAR — data through Q1 2026. EP10 has 720 MEPs from 27 EU countries. Plenary session count (54) reflects the full-year EP calendar; speeches (996) and adoptedTexts (104) reflect actual Q1 cumulative activity; other activity totals are projected full-year estimates based on 2021-2025 historical average with EP10 year-2 cycle adjustment. Actual Q1 activity: 10 plenary sittings completed (Jan-Feb), adopted texts and procedures accumulating. Defence spending, Clean Industrial Deal, and AI Act implementation dominating legislative agenda.' },
];
...
const RAW_MONTHLY_DATA: Record<number, Record<string, number[]>> = {
  ...
  2025: {
    ...
    events: [119, 158, 300, 262, 204, 237, 201, 5, 234, 365, 346, 233],
  },
  2024: {
...
export const GENERATED_STATS: GeneratedStatsData = {
  generatedAt: '2026-04-20T06:56:34Z',
