 ...
 * ```
 */
export function isMEPID(value: string): value is MEPID {
 ...
 * ```
 */
export function isCommitteeID(value: string): value is CommitteeID {
 ...
 */
export function createMEPID(value: string): MEPID {
  if (!isMEPID(value)) {
 ...
 * @security Input validation prevents injection attacks
 */
export function createCommitteeID(value: string): CommitteeID {
